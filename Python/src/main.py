...
def math_damege(atack_pokemon: str, waza_name: str, atack_effort: int, defense_pokemon: str, defense_effort: int):
    ...
    damege = (((50*2/5+2)* waza_power * math_attribute_value(atack,atack_effort) / math_attribute_value(defense,defense_effort )) / 50 + 2) * type_match(waza_type, atack_type1, atack_type2) * type_compatibility(waza_type, defense_type1, defense_type2)
    return {"min_damege":damege*0.85, "max_damege":damege}
